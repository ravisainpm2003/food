        ...
        <div className="footer-copyright border-top py-3 bg-light">
          <div className="container d-flex align-items-center">
            <div className="d-flex">
              <p className="mb-0">
                {" "}
                © 2025 <strong className="text-primay">
                  @Skills Uprise
                </strong>{" "}
                Company All rights reserved{" "}
              </p>
              <p className="ms-3 me-3">Devloped by </p>

              <strong>
                <a target="_blank" href="https://www.linkedin.com/in/ravi-sai/">
                  @Ravi
                </a>
                <a
                  className="ms-2"
                  target="_blank"
                  href="https://www.linkedin.com/in/vamsi-kumar-982558232"
                >
                  @Vamsi
                </a>
              </strong>
