            ...
            <div className="osahan-privacy bg-white rounded shadow-sm p-4">
              <div id="intro" className="mb-4">
                ...
                <p>
                  ...
                  Services are provided by Pixeel Ltd. ("Swiggiweb"), located at
              ...
              <div id="services" className="mb-4">
                ...
                <ul className="text-secondary">
                  <li className="pb-2">
                    When you register for a Swiggiweb account we collect your
                  ...
                  <li className="pb-2">
                    When you use the "Remember Me" feature of Swiggiweb
                    Checkout, we collect your email address, payment card
                    number, CVC code and expiration date.
                  </li>
                </ul>
                <p>
                  When you respond to Swiggiweb emails or surveys we collect
                  your email address, name and any other information you choose
                  to include in the body of your email or responses. If you
                  contact us by phone, we will collect the phone number you use
                  to call Swiggiweb. If you contact us by phone as a Swiggiweb
                  User, we may collect additional information in order to verify
                  your identity.
                </p>
                {/* Title */}
              ...
              <div id="privacy" className="mb-4">
                ...
                {/* End Title */}
                <p>
                  Swiggiweb's privacy policies explain how we treat your
              ...
              <div id="yourContent" className="active">
                ...
                <p>
                  ...
                  through our Services, you give Swiggiweb (and those we work
