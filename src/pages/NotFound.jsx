...
const NotFound = () => {
  ...
  <div className="d-none">
    <div className="bg-primary border-bottom p-3 d-flex align-items-center mb-4">
      ...
      <h4 className="fw-bold m-0 text-white">Not Found</h4>
    </div>
  </div>
  <div className="container osahan-coming-soon py-5 d-flex justify-content-center align-items-center">
    <div className="osahan-text text-center">
      <div className="osahan-img px-5 pb-5">
        <svg
          ...
          className="injected-svg modal__media modal__mobile__media"
      ...
      <h2 className="text-primary mb-3 font-weight-light">
        Page not <b>found</b>
      </h2>
      <p className="lead small mb-0">
        Oops! Looks like you followed a bad link.
      </p>
      <p className="mb-5">
        If you think this is a problem with us, please <a href="#">tell us</a>.
      </p>
