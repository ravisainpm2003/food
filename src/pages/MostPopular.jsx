    ...
    <div className="container">
      <div className="most_popular py-5">
        <div className="d-flex align-items-center mb-4">
          <h3 className="fw-bold text-dark mb-0">Most Popular</h3>
          <a
            href="#"
        ...
        <div className="d-flex col-12 align-items-center mb-4">
          <div className="  mb-3 col-12 col-md-4 px-2 py-2">
            <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
              <div className="list-card-image">
                <div className="popular-slider d-flex d-flex">
                  <div className="osahan-slider-item">
                    <a href="restaurant.html">
                      <img
                        alt="#"
                        src="img/popular1.png"
                        className="img-fluid item-img w-100 rounded"
                      />
                    </a>
                  </div>
                  <div className="osahan-slider-item">
          ...
          <div className="mb-3 col-12 col-md-4 px-2 py-2">
            <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
              <div className="list-card-image">
                <div className="popular-slider d-flex">
                  <div className="osahan-slider-item">
                    <a href="restaurant.html">
                      <img
                        alt="#"
        ...
        <div className="d-flex col-12 align-items-center mb-4">
          <div className="mb-3 col-12 col-md-3 px-2 py-2">
            <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
              <div className="list-card-image">
                <div className="popular-slider d-flex">
                  <div className="osahan-slider-item">
